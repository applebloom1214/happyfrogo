...
modalRegisterBtn.on("click",function(e){
    ...
    replyService.add(reply, function(result){
     ...
     // showList(1);
      showList(-1); // 댓글 등록 후 -1로 호출하여 마지막 댓글 페이지를 보여준다.
...
$(document).ready(function() {
  ...
  $("button[data-oper='modify']").on("click", function(e){
    ...
    operForm.attr("action","/happy/modify").submit();
  ...
  $("button[data-oper='list']").on("click", function(e){
    ...
    operForm.find("#bno").remove(); // 조회시에는 bno가 필요없으니 지운다.
    operForm.attr("action","/happy/list")
    operForm.submit();
